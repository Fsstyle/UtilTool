...
/* Add "Next Page" Button in Wordpress Editor */
...
/* SimpleHome Link Pages */
function simplehome_link_pages() {
	$previouspage = wp_link_pages('before=<div class="pages">&after=&next_or_number=next&previouspagelink=上一页&nextpagelink=&nbsp&echo=0');  
	if (strpos($previouspage, "上一页") !== false)
		echo $previouspage;
	else
		echo strip_tags($previouspage, '<div>');//$previouspage;
