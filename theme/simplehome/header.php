    ...
    <header class="left">
    	...
    	<div class="sns-icon">
        	<ul>
                ...
                <li class="sns-qq"><span>QQ:<?=(get_option('mytheme_qq')!='' ? get_option('mytheme_qq') : '89404697')?></span></li>
                <li class="sns-weichat"><span>微信:<?=(get_option('mytheme_weichat')!='' ? get_option('mytheme_weichat') : 'Fstyles')?></span></li>
    	...
    	<div class="face-area">
            ...
            <div class="face-name"><?=(get_option('mytheme_owner')!='' ? get_option('mytheme_owner') : 'BigQiu')?></div>
        </div>
    	<div class="search">
        	<?php
				get_search_form();
